...
<a class="btn btn-info" href="{{ url('/user/adduser')}}" >添加管理员</a>
 <a class="btn btn-danger" href="{{ url('/recuserlist')}}">管理员回收站</a>
                    ...
                    <table class="table table-bordered">
                      ...
                      <tr>
                       ...
                       <td>   
                         ...
                         <a class="btn btn-success delete-confirm" href="{{ url('/user/del',[$user->id] )}}" tip="确认删除吗？此次删除将放入回收站！" style="width:80px; float:left;margin:0px 2px;">删除</a>
                       </td>
                      </tr>
                      @endforeach
                     </tbody>
