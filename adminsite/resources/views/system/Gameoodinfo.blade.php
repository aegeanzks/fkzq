...
<label> 猜进球</label>
    ...
    <div class="col-sm-2">
    <label>主队进球</label>
    <input type="text" name="host_goal" id="host_goal"  class="form-control" placeholder="主队进球"  value="{{$data[0]['host_goal']}}"/>
   </div>
   <div class="col-sm-2">
   <label>无进球</label>
...
<label>  对阵双方</label>
    ...
    <option value="上中/中下">上中/中下</option> 
    <option value="上上/中中/下下">上上/中中/下下</option>
