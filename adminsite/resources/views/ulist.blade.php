...
<div class="row">
<form class="form-inline" method="get" action="{{ url('/userlist')}}">
<div class="box">
  ...
  <div class="box-body">
                    <table class="table table-bordered">
                      ...
                      <tr>
                       ...
                       <td>   
                         <a class="btn btn-warning" href="{{ url('/user/getInfo',[$user->id] )}}" style="width:80px; float:left;margin:0px 2px;">详细</a>
                         <a class="btn btn-info" href="{{ url('/user/editInfo',[$user->id] )}}" style="width:80px; float:left;margin:0px 2px;">修改</a>
                         <a class="btn btn-success" href="{{ url('/user/delInfo',[$user->id] )}}" style="width:80px; float:left;margin:0px 2px;">删除</a>
                       </td>
                      </tr>
                      @endforeach
                     </tbody>
