...
function VirtualFootballOddsAgent(conf, teamInfo1, teamInfo2, beginTime, endTime, odds){
    ...
    function reckonTimes(){
        ...
        switch(difNum){
            case 0:{
                self.strongWinTimes = timeScale[indexTimeScale]['0_host'];
                self.drawTimes = timeScale[indexTimeScale]['0_draw'];
                self.weakWinTimes = timeScale[indexTimeScale]['0_guest'];
            }break;
            case 1:{
                self.strongWinTimes = timeScale[indexTimeScale]['1_host'];
                self.drawTimes = timeScale[indexTimeScale]['1_draw'];
                self.weakWinTimes = timeScale[indexTimeScale]['1_guest'];
            }break;
            case 2:{
                self.strongWinTimes = timeScale[indexTimeScale]['2_host'];
                self.drawTimes = timeScale[indexTimeScale]['2_draw'];
                self.weakWinTimes = timeScale[indexTimeScale]['2_guest'];
            }break;
            case 3:{
                self.strongWinTimes = timeScale[indexTimeScale]['3_host'];
                self.drawTimes = timeScale[indexTimeScale]['3_draw'];
                self.weakWinTimes = timeScale[indexTimeScale]['3_guest'];
            }break;
            case -1:{
                self.strongWinTimes = timeScale[indexTimeScale]['-1_host'];
                self.drawTimes = timeScale[indexTimeScale]['-1_draw'];
